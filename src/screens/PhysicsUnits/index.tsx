...
const physicsUnits = [
  ...
  {
    id: '3',
    name: 'الأمواج المستقرة',
    icon: 'water',
    color: '#9C27B0'
  },
  {
    id: '4',
    name: 'الالكترونيات والجسم الصلب',
    icon: 'hardware-chip',
    color: '#FF9800'
  },
  {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>الفيزياء</Text>
...
export default PhysicsUnitsScreen; 