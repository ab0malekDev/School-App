...
const arabicUnits = [
  {
    id: '1',
    name: 'القضايا الوطنية والقومية',
    icon: 'flag' as const,
    color: '#E31E24'
  },
  {
    id: '2',
    name: 'الغربة والاغتراب في الادب المهجري',
    icon: 'globe' as const,
    color: '#2196F3'
  },
  {
  ...
  {
    id: '5',
    name: 'ادب القضايا الاجتماعية',
    icon: 'people' as const,
    color: '#FF9800'
  }
];

const ArabicUnitsScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>اللغة العربية</Text>
        <View style={styles.placeholder} />
      </View>

      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
        {arabicUnits.map((unit) => (
          <TouchableOpacity
            key={unit.id}
...
export default ArabicUnitsScreen; 